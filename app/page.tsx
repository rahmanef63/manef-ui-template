...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden selection:bg-primary/30">
      ...
      <StickyHeader className="px-6 py-4 border-b border-border/50 bg-background/50 backdrop-blur-xl z-50">
      ...
      <main className="relative z-10">
        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary border border-border text-sm font-medium text-muted-foreground mb-8 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
              <Sparkles className="w-4 h-4 text-primary" />
              <span>Next-Generation AI Workspace</span>
            </div>

            <h1 className="text-balance text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150 fill-mode-both">
              The ultimate infrastructure built for autonomous agents
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 fill-mode-both">
              <Link href="/login" className="w-full sm:w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-full">
              ...
              <Link href="https://github.com/xixixao/saas-starter" target="_blank" className="w-full sm:w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-full">
                <button className="w-full sm:w-auto px-8 py-4 bg-secondary border border-border text-foreground rounded-full font-semibold flex items-center justify-center gap-2 hover:bg-secondary/80 transition-all duration-300 backdrop-blur-sm">
                  View Documentation
                </button>
              </Link>
            </div>
        ...
        <section className="py-24 px-4 relative">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Feature 1 */}
              <div className="p-6 rounded-3xl bg-card border border-border hover:bg-accent/50 transition-colors group">
              ...
              {/* Feature 4 */}
              <div className="p-6 rounded-3xl bg-card border border-border hover:bg-accent/50 transition-colors group lg:col-span-2">
                <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                  <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 flex items-center justify-center shrink-0 group-hover:rotate-12 transition-transform">
                    <LayoutDashboard className="w-8 h-8 text-emerald-500 dark:text-emerald-400" />
                  </div>
                  <div>
        ...
        {/* Footer */}
        <footer className="border-t border-border/50 py-12 text-center text-sm text-muted-foreground mt-20 relative z-10">
