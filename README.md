...
Frontend dashboard for `manef`, served on `https://gg.<YOUR_DOMAIN>`.
...
- public endpoint: `https://dbgg.<YOUR_DOMAIN>`
...
Related files:
- [app/login/page.tsx](<USER_HOME>/projects/manef-ui/app/login/page.tsx)
- [app/set-password/page.tsx](<USER_HOME>/projects/manef-ui/app/set-password/page.tsx)
...
- [DiscoveryToolbar.tsx](<USER_HOME>/projects/manef-ui/shared/block/ui/layout/DiscoveryToolbar.tsx)
- [ThreePanelLayout.tsx](<USER_HOME>/projects/manef-ui/shared/block/ui/layout/ThreePanelLayout.tsx)
- [openclaw-blocks.tsx](<USER_HOME>/projects/manef-ui/shared/block/ui/openclaw-blocks.tsx)
...
Important docs:
- [ENVIRONMENT_MATRIX.md](<USER_HOME>/projects/manef-ui/docs/ENVIRONMENT_MATRIX.md)
- [DOKPLOY_DEPLOYMENT_CHECKLIST.md](<USER_HOME>/projects/manef-ui/docs/DOKPLOY_DEPLOYMENT_CHECKLIST.md)
...
- [docs/README.md](<USER_HOME>/projects/manef-ui/docs/README.md)
- [TARGET_ARCHITECTURE.md](<USER_HOME>/projects/manef-ui/docs/TARGET_ARCHITECTURE.md)
- [OPENCLAW_FRONTEND_PARITY_TASKLIST.md](<USER_HOME>/projects/manef-ui/docs/OPENCLAW_FRONTEND_PARITY_TASKLIST.md)
