...
Docker `dbgg.<YOUR_DOMAIN>`.

## 1. Frontend repo: `manef-ui`

Repo: `rahmanef63/manef-ui`
Domain: `https://gg.<YOUR_DOMAIN>`
...
Domain: `https://dbgg.<YOUR_DOMAIN>`

### Wajib di backend/Convex env

| Variable | Wajib | Dipakai di | Tujuan |
| --- | --- | --- | --- |
| `HOSTED_URL` | ya | invite email action | Link balik ke frontend `gg.<YOUR_DOMAIN>` |
...
| --- | --- | --- |
| `PUBLIC_DB_DOMAIN` | ya | Host public untuk proxy, default `dbgg.<YOUR_DOMAIN>` |
...
| --- | --- | --- |
| Frontend | `manef-ui` | `gg.<YOUR_DOMAIN>` |
| Backend/public endpoint | `manef-db` | `dbgg.<YOUR_DOMAIN>` |
