...
- [x] Referensi Convex yang sudah punya padanan di `@manef/db/api` harus
  ...
  - wrapper server-safe baru:
    [api.ts](<USER_HOME>/projects/manef-ui/shared/convex/api.ts)
  - wrapper `shared/convex/*` sekarang mengarah ke generated `typedApi`
  - vendor package `@manef/db` di
    [vendor/manef-db](<USER_HOME>/projects/manef-ui/vendor/manef-db)
    disinkronkan dari repo backend agar generated API tersedia saat build
- [x] Route string low-risk harus mulai dipusatkan.
  Bukti:
  - [routes.ts](<USER_HOME>/projects/manef-ui/shared/constants/routes.ts)
  - dipakai di:
    [DashboardButtons.tsx](<USER_HOME>/projects/manef-ui/features/dashboard/components/DashboardButtons.tsx),
    [DeleteWorkspaceDialog.tsx](<USER_HOME>/projects/manef-ui/features/settings/components/DeleteWorkspaceDialog.tsx),
    [CreateWorkspaceDialog.tsx](<USER_HOME>/projects/manef-ui/features/workspaces/components/CreateWorkspaceDialog.tsx)
...
- [x] Tambahkan `Feature Store` sebagai surface terpisah dari dashboard operasi.
  Bukti:
  - config feature:
    [config.ts](<USER_HOME>/projects/manef-ui/features/feature-store/config.ts)
  - halaman:
    [index.tsx](<USER_HOME>/projects/manef-ui/features/feature-store/index.tsx)
  - registry:
    [registry.tsx](<USER_HOME>/projects/manef-ui/features/registry.tsx)
  - menu admin:
    [index.ts](<USER_HOME>/projects/manef-ui/project/registry/navigation/index.ts)
- [x] `Feature Store` harus bisa menampilkan katalog builder:
  ...
  - source backend vendor:
    [api.ts](<USER_HOME>/projects/manef-ui/vendor/manef-db/convex/features/featureStore/api.ts)
...
- UI store:
  [MenuStorePage.tsx](<USER_HOME>/projects/superspace/frontend/features/menus/MenuStorePage.tsx)
- preview registry:
  [all-previews.ts](<USER_HOME>/projects/superspace/frontend/shared/preview/all-previews.ts)
...
- [x] Tambahkan admin guard backend/frontend yang lebih tegas untuk install/uninstall
  ...
  - halaman dashboard leaf sekarang menolak feature jika role viewer tidak
    ...
    [page.tsx](<USER_HOME>/projects/manef-ui/app/dashboard/[workspaceSlug]/[...catchAll]/page.tsx)
  - halaman `Skills` sekarang read-only untuk non-admin di workspace aktif:
    [index.tsx](<USER_HOME>/projects/manef-ui/features/skills/index.tsx)
    [SkillsList.tsx](<USER_HOME>/projects/manef-ui/features/skills/components/SkillsList.tsx)
...
- [x] Rapikan UX `Feature Store` dan `Skills Store` dengan pattern shared
  ...
  - shared layout:
    [ThreePanelLayout.tsx](<USER_HOME>/projects/manef-ui/shared/block/ui/layout/ThreePanelLayout.tsx)
...
- [x] Turunkan `grantedSkillKeys` feature menjadi policy agent/workspace yang nyata
  ...
  - file:
    [SidebarNavTreeBlock.tsx](<USER_HOME>/projects/manef-ui/shared/block/ui/layout/SidebarNavTreeBlock.tsx)
    [BottomNavBlock.tsx](<USER_HOME>/projects/manef-ui/shared/block/ui/layout/BottomNavBlock.tsx)
    [PageTabsBlock.tsx](<USER_HOME>/projects/manef-ui/shared/block/ui/layout/PageTabsBlock.tsx)
    [menu-utils.ts](<USER_HOME>/projects/manef-ui/shared/config/menu-utils.ts)
...
- [x] `WorkspaceRouteGuard` harus mengakui scope OpenClaw, bukan hanya workspace legacy.
  ...
  - file:
    [WorkspaceRouteGuard.tsx](<USER_HOME>/projects/manef-ui/features/workspaces/components/WorkspaceRouteGuard.tsx)
...
- [x] Tampilkan daftar agent live dari Convex tanpa fallback statis.
  Bukti:
  - [Agents.tsx](<USER_HOME>/projects/manef-ui/features/agents/components/Agents.tsx)
  - commit `90d3e45`
...
- [x] Tampilkan session live dari Convex sesuai `selectedScope.agentIds`.
  Bukti:
  - [index.tsx](<USER_HOME>/projects/manef-ui/features/sessions-list/index.tsx)
...
- [x] Hilangkan ketergantungan utama pada `CHANNEL_CONFIGS` fallback.
  Bukti:
  - [index.tsx](<USER_HOME>/projects/manef-ui/features/channels/index.tsx)
  - [ChannelCards.tsx](<USER_HOME>/projects/manef-ui/features/channels/components/ChannelCards.tsx)
  - file fallback dihapus:
    [index.ts](<USER_HOME>/projects/manef-ui/features/channels/constants/index.ts)
  - commit `a7beeef`
- [x] Tampilkan seluruh channel/account live dari Convex.
  ...
  - halaman sekarang memetakan seluruh hasil `features/channels/api:listChannels`
    di [index.tsx](<USER_HOME>/projects/manef-ui/features/channels/index.tsx)
  - commit `a7beeef`
...
- [x] Tampilkan binding `channel -> workspace` live di card channel.
  ...
  - mapping data di
    [index.tsx](<USER_HOME>/projects/manef-ui/features/channels/index.tsx)
  - type UI di
    [types/index.ts](<USER_HOME>/projects/manef-ui/features/channels/types/index.ts)
- [x] Tambahkan surface write untuk binding `channel/account -> workspace`.
  ...
  - memakai refs:
    [channels.ts](<USER_HOME>/projects/manef-ui/shared/convex/channels.ts)
...
- [x] Login menerima `email atau nomor telepon`.
  Bukti:
  - [page.tsx](<USER_HOME>/projects/manef-ui/app/login/page.tsx)
  - [auth.ts](<USER_HOME>/projects/manef-ui/auth.ts)
...
- [x] Temporary password harus memaksa user ke halaman ganti password.
  Bukti:
  - [page.tsx](<USER_HOME>/projects/manef-ui/app/set-password/page.tsx)
  - [proxy.ts](<USER_HOME>/projects/manef-ui/proxy.ts)
  - commit `53c63e0`
...
- [x] Tampilkan daftar node live dari DB.
  ...
  - query host/node live dipakai di
    [ExecApprovals.tsx](<USER_HOME>/projects/manef-ui/features/nodes/components/ExecApprovals.tsx)
...
- [x] Hilangkan `MOCK_LOGS`.
  Bukti:
  - [index.tsx](<USER_HOME>/projects/manef-ui/features/logs/index.tsx)
...
- [x] Tambahkan filter:
  ...
  - [LogStream.tsx](<USER_HOME>/projects/manef-ui/features/logs/components/LogStream.tsx)
  - [index.tsx](<USER_HOME>/projects/manef-ui/features/logs/index.tsx)
...
- [x] Sambungkan filter `activeWithin`, `limit`, dan `includeUnknown`.
  Bukti:
  - [index.tsx](<USER_HOME>/projects/manef-ui/features/sessions-list/index.tsx)
  - [SessionsList.tsx](<USER_HOME>/projects/manef-ui/features/sessions-list/components/SessionsList.tsx)
