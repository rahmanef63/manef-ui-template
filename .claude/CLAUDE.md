...
- **URL**: https://gg.rahmanef.com
- **Stack**: Next.js 16, React 19, NextAuth v5, Convex client, Radix UI, Tailwind v4, Zod
- **Backend**: manef-db (Convex Cloud) via `https://dbgg.rahmanef.com`
...
```bash
curl -si https://gg.rahmanef.com              # Frontend
curl -si https://dbgg.rahmanef.com/version    # Backend
