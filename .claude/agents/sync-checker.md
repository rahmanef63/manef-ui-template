...
stat /home/rahman/projects/manef-db/convex/schema.ts
stat /home/rahman/projects/manef-ui/vendor/manef-db/convex/schema.ts

# Check git status in both repos
cd /home/rahman/projects/manef-db && git log --oneline -5
cd /home/rahman/projects/manef-ui && git log --oneline -5
```

Also check: does vendor copy match source for recently changed files?
```bash
diff /home/rahman/projects/manef-db/convex/features/agents/api.ts \
     /home/rahman/projects/manef-ui/vendor/manef-db/convex/features/agents/api.ts
```
...
Backend Health:
  manef-db (dbgg.rahmanef.com): {status}
  manef-ui (gg.rahmanef.com):   {status}
