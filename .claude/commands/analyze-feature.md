...
ls -la <USER_HOME>/projects/manef-ui/features/{feature-name}/

# Cek pola import
grep -r "appApi\|useAppQuery\|useAppMutation" \
  <USER_HOME>/projects/manef-ui/features/{feature-name}/

# Cek apakah ada MOCK_* tersisa
grep -r "MOCK_" <USER_HOME>/projects/manef-ui/features/{feature-name}/

# Cek Convex domain yang digunakan
grep -r "appApi.features." <USER_HOME>/projects/manef-ui/features/{feature-name}/
```
