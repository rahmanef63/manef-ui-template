...
cd /home/rahman/projects/manef-db && git add -p && git commit
cd /home/rahman/projects/manef-ui && git add -p && git commit
```
...
# Step 4: Test manual
python3 /home/rahman/projects/manef-db/scripts/sync_openclaw_{domain}_to_convex.py
...
- [ ] Dashboard bisa diakses di https://gg.rahmanef.com
